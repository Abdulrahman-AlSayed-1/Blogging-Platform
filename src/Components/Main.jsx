  ...
  return (
    <div className="container p-3 md:min-h-[50vh] lg:min-h-screen my-3 flex flex-wrap-reverse mx-auto">
      <div className="w-full md:w-1/2 flex flex-col md:justify-center items-center text-center space-y-4">
        ...
        <h3 className="text-2xl lg:text-4xl home-title">TESLA THE FUTURE</h3>
        <p className="text-sm lg:text-lg text-storm-600">
          <Typewriter
            words={[`Tesla’s innovations and expanding EV market lead transportation’s
